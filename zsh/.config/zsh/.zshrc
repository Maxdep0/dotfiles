...
# ZSH Autocomplete
if [ -s "$ZSH_PLUGINS_DIR/zsh-autocomplete/zsh-autocomplete.plugin.zsh" ]; then
    source "$ZSH_PLUGINS_DIR/zsh-autocomplete/zsh-autocomplete.plugin.zsh"
else
    [ -d "$ZSH_PLUGINS_DIR/zsh-autocomplete" ] || mkdir -pv "$ZSH_PLUGINS_DIR/zsh-autocomplete"
    git clone --depth 1 -- https://github.com/marlonrichert/zsh-autocomplete.git "$ZSH_PLUGINS_DIR/zsh-autocomplete"
    source "$ZSH_PLUGINS_DIR/zsh-autocomplete/zsh-autocomplete.plugin.zsh"
fi
